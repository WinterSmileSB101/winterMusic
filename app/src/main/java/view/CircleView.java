...
/**
 * 圆形view
 * Created by SmileSB101 on 2016/10/27 0027.
 */
...
public class CircleView extends ImageView{
	...
	public CircleView(Context context,AttributeSet attrs,Context mContext){
		super(context,attrs);
		this.mContext = mContext;
		setCustomAttributes(attrs);
	}

	public CircleView(Context context,AttributeSet attrs,int defStyleAttr,Context mContext){
		super(context,attrs,defStyleAttr);
		this.mContext = mContext;
		setCustomAttributes(attrs);
	}

	public CircleView(Context context,AttributeSet attrs,int defStyleAttr,int defStyleRes,Context mContext){
